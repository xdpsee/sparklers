...
import com.zhenhui.sparkler.data.model.core.common.misc.content.Audio;
...
import com.zhenhui.sparkler.data.model.core.common.misc.content.Video;
...
public class PostValidTest {
    ...
    public static void main(String[] args) {
        ...
        PostRO ro = JsonUtils.fromJsonString(json, new TypeReference<PostRO>() {
        });
